...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('ʀᴇᴘᴏ', url='https://t.me/+LVTlT_SJ_ZZkNmY1'),
        ],[
            InlineKeyboardButton('ʜᴏᴍᴇ', callback_data='start'),
        ...
        buttons = [[
            InlineKeyboardButton('𝚂𝚄𝙿𝙿𝙾𝚁𝚃', url='https://t.me/cinema_kalavara'),
            InlineKeyboardButton('𝚄𝙿𝙳𝙰𝚃𝙴𝚂', url='https://t.me/sanusmoviesch')
            ],[
        ...
        buttons = [[
           InlineKeyboardButton('ʀᴇᴘᴏ', url='https://t.me/+LVTlT_SJ_ZZkNmY1'),
           InlineKeyboardButton('ᴏᴡɴᴇʀ', url='https://t.me/+LVTlT_SJ_ZZkNmY1')
        ], [
            InlineKeyboardButton('ʙᴀᴄᴋ', callback_data='help')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
